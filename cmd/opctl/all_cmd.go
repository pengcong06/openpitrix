...
func (c *CreateReleaseCmd) ParseFlag(f Flag) {
	...
	f.StringVarP(&c.RuntimeID, "runtime_id", "", "", "required, id of runtime")
	f.StringVarP(&c.Values, "values", "", "", "custom value")
	f.StringVarP(&c.VersionID, "version_id", "", "", "required, id of app version")
}
...
type DescribeReleaseCmd struct {
	*release_manager.DescribeReleaseParams
}

func NewDescribeReleaseCmd() Cmd {
	return &DescribeReleaseCmd{
		release_manager.NewDescribeReleaseParams(),
	}
}

func (*DescribeReleaseCmd) GetActionName() string {
	return "DescribeRelease"
}

func (c *DescribeReleaseCmd) ParseFlag(f Flag) {
...
func (c *DescribeReleaseCmd) Run(out Out) error {
	params := c.DescribeReleaseParams

	out.WriteRequest(params)

	client := getClient()
	res, err := client.ReleaseManager.DescribeRelease(params, nil)
	if err != nil {
		return err
	}
