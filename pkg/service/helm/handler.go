...
func (server *Server) CreateRelease(ctx context.Context, req *pb.CreateReleaseRequest) (*pb.CreateReleaseResponse, error) {
...
func (server *Server) ListReleases(ctx context.Context, req *pb.ListReleasesRequest) (*pb.ListReleaseResponse, error) {
	runtimeId := req.GetRuntimeId().GetValue()
	cfg, err := getActionConfig(ctx, runtimeId, Driver, DefaultCredentialGetter)
	if err != nil {
		return nil, gerr.NewWithDetail(ctx, gerr.Internal, err, gerr.ErrorInternalError)
...
func (server *Server) DescribeRelease(ctx context.Context, req *pb.DescribeReleaseRequest) (*pb.DescribeReleaseResponse, error) {

}

func (server *Server) UpgradeRelease(ctx context.Context, req *pb.UpgradeReleaseRequest) (*pb.UpgradeReleaseResponse, error) {
	runtimeId := req.GetRuntimeId().GetValue()
...
func (server *Server) RollbackRelease(ctx context.Context, req *pb.RollbackReleaseRequest) (*pb.RollbackReleaseResponse, error) {
	runtimeId := req.GetRuntimeId().GetValue()
	releaseName := req.GetReleaseName().GetValue()
...
func (server *Server) DeleteRelease(ctx context.Context, req *pb.DeleteReleaseRequest) (*pb.DeleteReleaseResponse, error) {
	runtimeId := req.GetRuntimeId().GetValue()
	releaseName := req.GetReleaseName().GetValue()
